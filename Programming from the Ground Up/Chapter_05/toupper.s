#PURPOSE:		This program concerts an input file
...
#					c) write the memory buffer to an output file
...
#				buffer with the upper-cased version.
#
#VARIABLES:
...
convert_to_upper:
 ...
 movl $0, %edi
 #if a buffer with zero length was givrn
 #to us, just leave
 cmpl $0, %ebx
 je end_convert_loop
...
next_byte:
 incl %edi 			#next byte
 cmpl %edi, %ebx 	#continue unless we've
 					#reached the end
 jne convert_loop
