#PURPOSE: 	Convert an integer into a decial string
#		  	for display
#
...
#
#OUTPUT:	The buffer string will be overwritten with the
#			decimal string
#
#Variables:
#
...
# %edi will hold the value of the base (10)
#
 .equ ST_VALUE,8
 .equ ST_BUFFER, 12
...
copy_reversing_loop:
 ...
 #Check to see if we are finsihed
 cmpl 	$0, %ecx
